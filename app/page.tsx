...
const COMPANIES: Company[] = [
  { name: "Airbnb", batch: "W09", valuation: 84, raised: "$6.4B", category: "moderate", story: "Voted #1 in their batch. Raised from Sequoia. Sold cereal boxes to survive early on.", industry: "Travel", founded: 2008, seedYear: 2009, seriesAYear: 2011, unicornYear: 2014, status: "public" },
  { name: "Stripe", batch: "S09", valuation: 159, raised: "$9.4B", category: "moderate", story: "First customer in 2 weeks via YC network. Sequoia early. Still private at $159B.", industry: "Fintech", founded: 2010, seedYear: 2010, seriesAYear: 2012, unicornYear: 2014, status: "active" },
  ...
  { name: "OpenSea", batch: "W18", valuation: 0, raised: "$427M", category: "sleeper", story: "Peaked at $13B during NFT mania. Sold to Coinbase for undisclosed amount at massive loss.", industry: "Crypto", founded: 2017, seedYear: 2018, seriesAYear: 2021, unicornYear: 2021, status: "acquired" },
  ...
  { name: "Reddit", batch: "S05", valuation: 33, raised: "$1.3B", category: "moderate", story: "19 years from YC to IPO. Longest timeline of any YC company.", industry: "Social", founded: 2005, seedYear: 2005, seriesAYear: 2007, unicornYear: 2017, status: "public" },
  ...
  { name: "Whatnot", batch: "W20", valuation: 11.5, raised: "$710M", category: "moderate", story: "100+ investor meetings. Raised from friends. Pivoted post-Demo Day. Series F at $11.5B.", industry: "E-commerce", founded: 2019, seedYear: 2020, seriesAYear: 2021, unicornYear: 2022, status: "active" },
  { name: "GOAT Group", batch: "W11", valuation: 3.7, raised: "$493M", category: "moderate", story: "Original YC company (GrubWithUs) failed. Years of middling ideas before pivot.", industry: "E-commerce", founded: 2015, seedYear: 2016, seriesAYear: 2017, unicornYear: 2020, status: "active" },
  ...
  { name: "Amplitude", batch: "W12", valuation: 0.87, raised: "$336M", category: "sleeper", story: "Product analytics. IPO'd. Market cap ~$870M.", industry: "Analytics", founded: 2012, seedYear: 2013, seriesAYear: 2015, status: "public" },
  { name: "PlanGrid", batch: "W12", valuation: 0.875, raised: "$69M", category: "sleeper", story: "Construction tech. Acquired by Autodesk for $875M.", industry: "Construction", founded: 2011, seedYear: 2012, seriesAYear: 2014, status: "acquired" },
  { name: "Heroku", batch: "W08", valuation: 0.212, raised: "$13M", category: "sleeper", story: "Cloud platform. Acquired by Salesforce for $212M.", industry: "Cloud", founded: 2007, seedYear: 2008, seriesAYear: 2009, status: "acquired" },
  { name: "Zenefits", batch: "W13", valuation: 0, raised: "$584M", category: "sleeper", story: "a16z Series A. $4.5B peak valuation. CEO ousted for fraud.", industry: "HR", founded: 2013, seedYear: 2013, seriesAYear: 2014, unicornYear: 2015, status: "dead" },
  ...
  { name: "Embark Trucks", batch: "W16", valuation: 0, raised: "$317M", category: "sleeper", story: "SPAC at $5.2B. Stock crashed to $60M. Shut down 2023.", industry: "Autonomous", founded: 2016, seedYear: 2016, seriesAYear: 2018, status: "dead" },
  { name: "Momentus", batch: "S18", valuation: 0, raised: "$160M", category: "sleeper", story: "SPAC at $1B+. SEC fraud charges. Collapsed.", industry: "Space", founded: 2017, seedYear: 2018, seriesAYear: 2019, status: "dead" },
  { name: "Notable Labs", batch: "W15", valuation: 0, raised: "$55M", category: "sleeper", story: "Public biotech company. Filed for bankruptcy Oct 2024.", industry: "Biotech", founded: 2014, seedYear: 2015, seriesAYear: 2017, status: "dead" },
  ...
  { name: "Zip", batch: "S20", valuation: 2.2, raised: "$370M", category: "moderate", story: "Procurement platform. Raised $1.7M at Demo Day, then exploded.", industry: "SaaS", founded: 2020, seedYear: 2020, seriesAYear: 2021, unicornYear: 2022, status: "active" },
  ...
  { name: "Ginkgo Bioworks", batch: "S14", valuation: 0.4, raised: "$2.8B", category: "sleeper", story: "SPAC at $17.5B valuation. Stock crashed 97%. Synthetic biology hype cycle.", industry: "Biotech", founded: 2009, seedYear: 2014, seriesAYear: 2015, unicornYear: 2020, status: "public" },
  ...
  { name: "Docker", batch: "S10", valuation: 2.1, raised: "$392M", category: "moderate", story: "Applied as dotCloud (PaaS). Container side project became the product.", industry: "Dev Tools", founded: 2008, seedYear: 2010, seriesAYear: 2013, unicornYear: 2015, status: "active" },
  ...
  { name: "PostHog", batch: "W20", valuation: 1.4, raised: "$180M", category: "moderate", story: "Pivoted 6 times in 6 months, launched MVP on Hacker News, hit 1,500 GitHub stars in 2 weeks. Open-source product analytics unicorn.", industry: "Analytics", founded: 2020, seedYear: 2020, seriesAYear: 2021, unicornYear: 2025, status: "active" },
  ...
  { name: "Lever", batch: "S12", valuation: 0.5, raised: "$122M", category: "sleeper", story: "Recruiting ATS. Acquired by Employ Inc. Steady SaaS play.", industry: "HR", founded: 2012, seedYear: 2013, seriesAYear: 2015, status: "acquired" },
  ...
  { name: "Vetcove", batch: "S16", valuation: 1.6, raised: "$120M", category: "moderate", story: "Amazon for veterinarians. Quietly grew to $1.6B. Zero hype at Demo Day.", industry: "Healthcare", founded: 2015, seedYear: 2016, seriesAYear: 2019, unicornYear: 2024, status: "active" },
  ...
  { name: "Solugen", batch: "W17", valuation: 2, raised: "$656M", category: "moderate", story: "Plant-sugar-to-chemicals got modest Demo Day attention. First YC climate tech unicorn.", industry: "Climate", founded: 2016, seedYear: 2017, seriesAYear: 2019, unicornYear: 2022, status: "active" },
  ...
  { name: "Apollo.io", batch: "W16", valuation: 1.6, raised: "$250M", category: "moderate", story: "Sales intelligence grew slowly for years then exploded to $150M ARR. Capital-efficient unicorn.", industry: "Sales", founded: 2015, seedYear: 2016, seriesAYear: 2021, unicornYear: 2023, status: "active" },
  { name: "Gecko Robotics", batch: "S16", valuation: 1.25, raised: "$354M", category: "hot-failed", story: "Wall-climbing inspection robots for power plants. Founded at 19. Took 12 years to unicorn.", industry: "Robotics", founded: 2013, seedYear: 2016, seriesAYear: 2018, unicornYear: 2025, status: "active" },
  { name: "Astranis", batch: "W16", valuation: 2, raised: "$753M", category: "moderate", story: "Small geostationary satellites. Demo Day investors skeptical of hardware. Now $2B+ with defense contracts.", industry: "Space", founded: 2015, seedYear: 2016, seriesAYear: 2018, unicornYear: 2024, status: "active" },
  { name: "Front", batch: "S14", valuation: 1.7, raised: "$202M", category: "moderate", story: "Shared inbox for teams seemed incremental. Steadily grew to $100M ARR and $1.7B.", industry: "SaaS", founded: 2013, seedYear: 2014, seriesAYear: 2016, unicornYear: 2022, status: "active" },
  ...
  { name: "Xendit", batch: "S15", valuation: 1, raised: "$530M", category: "moderate", story: "First Southeast Asian YC company. Pivoted from Bitcoin to payment infrastructure. Processes $15B/year in Indonesia.", industry: "Fintech", founded: 2015, seedYear: 2015, seriesAYear: 2018, unicornYear: 2021, status: "active" },
  { name: "Paystack", batch: "W16", valuation: 0.2, raised: "$11.7M", category: "sleeper", story: "First Nigerian YC company. Processed half of Nigeria's online transactions. Acquired by Stripe for $200M+.", industry: "Fintech", founded: 2015, seedYear: 2016, seriesAYear: 2018, status: "acquired" },
  ...
  { name: "Stoke Space", batch: "W21", valuation: 2, raised: "$175M", category: "moderate", story: "Fully reusable rocket by Blue Origin veterans. Quietly building while SpaceX dominates headlines.", industry: "Space", founded: 2019, seedYear: 2021, seriesAYear: 2023, unicornYear: 2024, status: "active" },
  ...
  { name: "Weave", batch: "W14", valuation: 0.7, raised: "$168M", category: "hot-won", story: "Communication platform for small healthcare businesses. Went public on NYSE 2021.", industry: "SaaS", founded: 2008, seedYear: 2015, seriesAYear: 2017, status: "public" },
  ...
  { name: "Codecademy", batch: "S11", valuation: 0.525, raised: "$87.5M", category: "hot-won", story: "Taught millions to code for free. One of the most culturally impactful ed-tech companies. Acquired by Skillsoft for $525M.", industry: "EdTech", founded: 2011, seedYear: 2011, seriesAYear: 2012, status: "acquired" },
  ...
  { name: "SingleStore", batch: "W11", valuation: 1.3, raised: "$464M", category: "moderate", story: "Originally MemSQL. Cloud-native distributed SQL combining transactional + analytical workloads. Quiet path to unicorn.", industry: "Data", founded: 2011, seedYear: 2011, seriesAYear: 2013, unicornYear: 2021, status: "active" },
  ...
  { name: "Corgi Insurance", batch: "S24", valuation: 2.6, raised: "$108M", category: "moderate", story: "Full-stack insurance carrier for startups. $630M in Jan 2026, unicorn by May, $2.6B by late May. Fastest YC insurtech ever.", industry: "Insurance", founded: 2024, seedYear: 2024, seriesAYear: 2026, unicornYear: 2026, status: "active" },
  // CLASSIC DEEP DIVE
  ...
  // S16-W19 MID ERA
  { name: "Athelas", batch: "S16", valuation: 7, raised: "$136M", category: "moderate", story: "Started as blood diagnostics device, pivoted to healthcare AI platform (now Commure). $7B valuation on just $136M raised — remarkable capital efficiency.", industry: "Healthcare", founded: 2016, seedYear: 2016, seriesAYear: 2019, unicornYear: 2022, status: "active" },
  ...
  { name: "Mux", batch: "W16", valuation: 1, raised: "$177M", category: "moderate", story: "Video API infrastructure for developers. Quietly became the backend for streaming across thousands of companies.", industry: "Dev Tools", founded: 2015, seedYear: 2016, seriesAYear: 2019, unicornYear: 2021, status: "active" },
  ...
  { name: "Airbyte", batch: "W20", valuation: 2, raised: "$181M", category: "moderate", story: "Pivoted 3 times in their first YC month, landed on open-source ELT data integration. Now the standard with 600+ connectors.", industry: "Data", founded: 2020, seedYear: 2020, seriesAYear: 2021, unicornYear: 2024, status: "active" },
  { name: "Pave", batch: "W20", valuation: 1.6, raised: "$175M", category: "moderate", story: "Compensation benchmarking used by 900+ companies. One-third of customers from the YC network. Quiet but dominant.", industry: "HR Tech", founded: 2019, seedYear: 2020, seriesAYear: 2021, unicornYear: 2022, status: "active" },
  // S22-S25 AI BOOM
  ...
  // FINTECH / B2B SAAS
  { name: "Hightouch", batch: "S19", valuation: 1.2, raised: "$180M", category: "moderate", story: "Reverse ETL pioneer that became the leading composable CDP. Now powering AI decisioning for enterprise marketing.", industry: "Data", founded: 2018, seedYear: 2019, seriesAYear: 2021, unicornYear: 2025, status: "active" },
  ...
  { name: "Nurx", batch: "W16", valuation: 0.3, raised: "$96M", category: "hot-won", story: "Telehealth for birth control and PrEP. Chelsea Clinton on board. Scaled to $300M, merged into Thirty Madison.", industry: "Healthcare", founded: 2014, seedYear: 2016, seriesAYear: 2017, status: "acquired" },
  ...
  { name: "Modern Treasury", batch: "S18", valuation: 2, raised: "$185M", category: "moderate", story: "Payment operations platform for moving money at scale. Powers automated payment flows for enterprises.", industry: "Fintech", founded: 2018, seedYear: 2018, seriesAYear: 2020, unicornYear: 2022, status: "active" },
  { name: "Mashgin", batch: "W15", valuation: 1.5, raised: "$82.5M", category: "moderate", story: "AI self-checkout kiosks using computer vision. $1.5B valuation on just $82M raised — capital-efficient unicorn.", industry: "AI", founded: 2014, seedYear: 2015, seriesAYear: 2018, unicornYear: 2022, status: "active" },
  ...
  { name: "People.ai", batch: "W16", valuation: 1.1, raised: "$200M", category: "hot-failed", story: "AI platform capturing business activity data to drive revenue growth. Accepted into YC within 30 days of founding.", industry: "AI", founded: 2016, seedYear: 2016, seriesAYear: 2018, unicornYear: 2021, status: "active" },
  ...
  { name: "CaptivateIQ", batch: "W18", valuation: 1.25, raised: "$164M", category: "moderate", story: "Sales commission management platform. Solved the spreadsheet nightmare of calculating sales comp.", industry: "SaaS", founded: 2017, seedYear: 2018, seriesAYear: 2020, unicornYear: 2022, status: "active" },
  ...
  { name: "Teleport", batch: "W15", valuation: 1.1, raised: "$169M", category: "moderate", story: "Zero-trust infrastructure access platform. Secure access to servers, Kubernetes, and databases.", industry: "Security", founded: 2015, seedYear: 2015, seriesAYear: 2019, unicornYear: 2022, status: "active" },
  { name: "Ajaib", batch: "S19", valuation: 1, raised: "$243M", category: "hot-failed", story: "Indonesia's leading online brokerage. Democratized stock investing for millions of Indonesians.", industry: "Fintech", founded: 2019, seedYear: 2019, seriesAYear: 2021, unicornYear: 2021, status: "active" },
  ...
  { name: "Sift", batch: "S11", valuation: 1.3, raised: "$157M", category: "moderate", story: "Digital trust and safety platform detecting fraud in real-time. Powers fraud prevention for 34K+ sites.", industry: "Security", founded: 2011, seedYear: 2011, seriesAYear: 2014, unicornYear: 2021, status: "active" },
  ...
  { name: "Nourish", batch: "W21", valuation: 1.75, raised: "$100M", category: "moderate", story: "Connects patients with dietitians via telehealth, covered by insurance. Tackling chronic disease through nutrition.", industry: "Healthcare", founded: 2021, seedYear: 2021, seriesAYear: 2023, unicornYear: 2025, status: "active" },
  ...
  { name: "Gem", batch: "S17", valuation: 1.2, raised: "$148M", category: "moderate", story: "Talent engagement platform unifying recruiting data. Used by Lyft, Spotify, Affirm. 800+ business customers.", industry: "HR Tech", founded: 2017, seedYear: 2017, seriesAYear: 2019, unicornYear: 2021, status: "active" },
  ...
  { name: "Vendr", batch: "S19", valuation: 0, raised: "$216M", category: "sleeper", story: "AI SaaS purchasing platform. Raised $216M, hit unicorn, then shut down in 2023.", industry: "SaaS", founded: 2019, seedYear: 2019, seriesAYear: 2021, unicornYear: 2022, status: "dead" },
  ...
  // FINAL SWEEP
  { name: "Prometheus", batch: "S19", valuation: 1.5, raised: "$24.1M", category: "moderate", story: "First e-fuels unicorn. Removes CO2 from air, uses solar/wind to make zero-net-carbon gasoline cheaper than fossil fuels.", industry: "Climate", founded: 2019, seedYear: 2019, seriesAYear: 2021, unicornYear: 2022, status: "active" },
  { name: "Eight Sleep", batch: "W16", valuation: 1.5, raised: "$160M", category: "moderate", story: "Smart mattress cover with heating/cooling and sleep tracking. Unicorn in March 2026. Founders Fund-backed.", industry: "Consumer", founded: 2014, seedYear: 2016, seriesAYear: 2018, unicornYear: 2026, status: "active" },
  ...
  { name: "CoreOS", batch: "S13", valuation: 0.25, raised: "$50M", category: "sleeper", story: "Built Container Linux and contributed to Kubernetes ecosystem. Red Hat (IBM) acquired for $250M.", industry: "Dev Tools", founded: 2013, seedYear: 2013, seriesAYear: 2014, status: "acquired" },
  ...
  { name: "Rigetti Computing", batch: "S14", valuation: 0.15, raised: "$254M", category: "sleeper", story: "Full-stack quantum computing. SPAC'd in 2022. Stock crashed 90%+ from peak. Quantum remains a long bet, but they're still building.", industry: "Quantum Computing", founded: 2013, seedYear: 2014, seriesAYear: 2016, status: "public" },
  ...
  { name: "North", batch: "W13", valuation: 0.18, raised: "$267M", category: "sleeper", story: "Smart glasses (Focals) — the most consumer-friendly AR glasses ever made. Raised $267M, but Google acquired for just $180M. A cautionary hardware tale.", industry: "Hardware", founded: 2012, seedYear: 2013, seriesAYear: 2014, status: "acquired" },
  ...
  { name: "Lucira Health", batch: "S14", valuation: 0.39, raised: "$85M", category: "sleeper", story: "First FDA-authorized at-home COVID-19 molecular test. IPO'd during pandemic. Pfizer acquired for $390M.", industry: "Healthcare", founded: 2013, seedYear: 2014, seriesAYear: 2017, status: "acquired" },
  { name: "Pardes Biosciences", batch: "S21", valuation: 0.05, raised: "$220M", category: "sleeper", story: "Oral antiviral for COVID. IPO'd in 2021 at $1.2B. Drug failed trials, company pivoted to autoimmune. Stock collapsed.", industry: "Biotech", founded: 2020, seedYear: 2021, seriesAYear: 2021, status: "public" },
  ...
  { name: "The Athletic", batch: "S16", valuation: 0.55, raised: "$140M", category: "sleeper", story: "Subscription sports journalism that challenged legacy media. NYT acquired for $550M in 2022.", industry: "Media", founded: 2016, seedYear: 2016, seriesAYear: 2017, status: "acquired" },
  { name: "Heap", batch: "W13", valuation: 0.96, raised: "$216M", category: "sleeper", story: "Auto-capture product analytics — no manual event tagging needed. Contentsquare acquired for $960M in 2023.", industry: "Analytics", founded: 2012, seedYear: 2013, seriesAYear: 2015, status: "acquired" },
  ...
  { name: "Modern Fertility", batch: "S17", valuation: 0.225, raised: "$22M", category: "sleeper", story: "At-home fertility hormone testing. Democratized reproductive health data. Ro acquired for $225M in 2021.", industry: "Healthcare", founded: 2017, seedYear: 2017, seriesAYear: 2019, status: "acquired" },
  ...
  { name: "Sqreen", batch: "W18", valuation: 0.22, raised: "$35M", category: "sleeper", story: "Runtime application security platform. Datadog acquired to expand their security portfolio.", industry: "Security", founded: 2015, seedYear: 2018, seriesAYear: 2019, status: "acquired" },
  ...
  { name: "HackerRank", batch: "S11", valuation: 1, raised: "$115M", category: "hot-failed", story: "Developer skills assessment platform used by 3,000+ companies for technical hiring.", industry: "HR Tech", founded: 2009, seedYear: 2012, seriesAYear: 2014, unicornYear: 2021, status: "active" },
  ...
  { name: "RevenueCat", batch: "S18", valuation: 1.2, raised: "$140M", category: "hot-failed", story: "In-app subscription SDK used by 30,000+ apps. The invisible infrastructure behind mobile purchases.", industry: "Dev Tools", founded: 2017, seedYear: 2018, seriesAYear: 2021, unicornYear: 2023, status: "active" },
    ...
    <main>
      ...
      <section className="relative overflow-hidden bg-yc-dark min-h-[85vh] sm:min-h-screen flex flex-col justify-center hero-grain">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 sm:px-8 py-20 w-full">
          ...
          >
            {[
              { big: "0.92", label: "Era-adjusted odds ratio", sub: "hot vs. unicorn odds — not significant" },
              { big: "4,716", label: "Companies analyzed", sub: "20 yrs, verified via research" },
        ...
        <div className="max-w-5xl mx-auto px-6 sm:px-8 py-16 sm:py-24">
          <Reveal>
            ...
            <p className="text-neutral-500 mt-2 text-sm sm:text-base max-w-2xl">
              YC&apos;s returns follow an extreme power law. Stripe, Airbnb, DoorDash, Coinbase, and Scale AI account for over half of all YC portfolio value.
            </p>
          </Reveal>
            ...
            <Reveal delay={100}>
              <div className="space-y-4">
                {[
                  ...
                  { n: "3/5", label: "of the top 5 were sleepers", sub: "Airbnb, DoorDash, and Coinbase were overlooked" },
                ].map((s, i) => (
