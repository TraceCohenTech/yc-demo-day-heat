...
const COMPANIES: Company[] = [
  ...
  { name: "Ramp", batch: "W19", valuation: 8.1, raised: "$1.6B", category: "hot-won", story: "Raised fast post-Demo Day. Grew to $8.1B in 4 years.", industry: "Fintech" },
  ...
  { name: "Applied Intuition", batch: "S17", valuation: 6, raised: "$450M", category: "sleeper", story: "AV simulation tools. Under the radar at Demo Day. Now valued at $6B.", industry: "Autonomous" },
  ...
  { name: "Docker", batch: "S10", valuation: 4, raised: "$392M", category: "sleeper", story: "Applied as dotCloud (PaaS). Container side project became the product.", industry: "Dev Tools" },
  ...
  { name: "Machine Zone", batch: "S08", valuation: 5, raised: "$8M", category: "sleeper", story: "Game of War made $1B+/year. Kate Upton Super Bowl ads. Peak $5B.", industry: "Gaming" },
  ...
  { name: "Boom Supersonic", batch: "W16", valuation: 8, raised: "$700M", category: "hot-won", story: "Building supersonic jets. United ordered 15. Valued at $8B.", industry: "Aviation" },
  { name: "Airtable", batch: "W12", valuation: 11.7, raised: "$1.4B", category: "sleeper", story: "Spreadsheet-database hybrid. Barely got into YC. Grew to $11.7B.", industry: "SaaS" },
  ...
  { name: "Monzo", batch: "S16", valuation: 5, raised: "$1.1B", category: "hot-won", story: "UK neobank. Coral debit card became a status symbol. 9M+ customers.", industry: "Fintech" },
  ...
  { name: "Kustomer", batch: "S14", valuation: 4, raised: "$174M", category: "moderate", story: "CRM platform. Acquired by Meta for $1B in 2022.", industry: "SaaS" },
